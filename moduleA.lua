-- Module A: Core + Services + Root UI (Polished Version)
...
if RunService:IsStudio() then
    ...
    API = HttpService:JSONDecode(game:HttpGet("https://raw.githubusercontent.com/ROBLOX404/locales/refs/heads/main/localeids.json"))
...
TabBackground.Image = "rbxassetid://13160452107" -- HD, mobile-safe gradient
TabBackground.ImageTransparency = 0.1
TabBackground.ScaleType = Enum.ScaleType.Stretch -- prevents cropping
